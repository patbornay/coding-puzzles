...
const binarySearch30 = (nums: number[], target: number): number => {
...
const binarySearch29 = (nums: number[], target: number): number => {
    let left = 0, right = nums.length - 1;
    while (left < right) {
        const mid = Math.floor((left + right)/2);
        if (nums[mid] === target) return mid;
...
const binarySearch28 = (nums: number[], target: number): number => {
    let left = 0, right = nums.length - 1;
    while (left < right) {
        const mid = Math.floor((left + right)/2);
        if (nums[mid] === target) return mid;
...
const binarySeach27 = (nums: number[], target: number): number => {
    let left = 0, right = nums.length - 1;
    while (left < right) {
        const mid = Math.floor((left + right)/2);
        if (nums[mid] === target) return mid;
...
const binarySearch26 = (nums: number[], target: number): number => {
    let left = 0, right = nums.length - 1;
    while (left < right) {
        const mid = Math.floor((left + right)/2);
        if (nums[mid] === target) return mid;
...
const binarySearch25 = (nums: number[], target: number): number => {
    let left = 0, right = nums.length -1;
    while (left < right) {
        const mid = Math.floor((left + right) / 2);
        if (nums[mid] === target) return mid;
...
const binarySearch24 = (nums: number[], target: number): number => {
    let left = 0, right = nums.length -1;
    while (left < right) {
        const mid = Math.floor((left + right) / 2);
        if (nums[mid] === target) return mid;
...
// rep 23 29/5/25
const binarySearch23 = (nums: number[], target: number): number => {
...
// rep 20 24/4/25
const binarySearch20 = (nums: number[], target: number): number => {
...
// rep 19 12/4/25
const binarySearch19 = (nums: number[], target: number): number => {
    let left = 0, right = nums.length -1;
...
// rep 29/03/25
const binarySearch18 = (nums: number[], target: number): number => {
    let left = 0, right = nums.length - 1;
    while (left <= right) {
        const mid = Math.floor((left + right) / 2);
        if (nums[mid] === target) return mid;
...
// rep 27/03/25
const binarySearch17 = (nums: number[], target: number): number => {
    let left = 0, right = nums.length - 1;
    while (left <= right) {
        const mid = Math.floor((left + right) / 2);
        if (nums[mid] === target) return mid;
...
const binarySearch16 = (nums: number[], target: number): number => {
    let left = 0, right = nums.length - 1;
    while (left <= right) {
        const mid = Math.floor((left + right) / 2);
        if (nums[mid] === target) return mid;
...
const binarySearch15 = (nums: number[], target: number): number => {
    let left = 0, right = nums.length - 1; 
    while (left <= right) {
        const mid = Math.floor((left + right) / 2);
        if (nums[mid] === target) return mid;
...
// rep 24/03/25
const binarySearch14 = (nums: number[], target: number): number => {
    let left = 0, right = nums.length - 1;
    while (left <= right) {
        const mid = Math.floor((left + right) / 2);
        if (nums[mid] === target) return mid;
...
// rep 23/03/25
const binarySearch13 = (nums: number[], target: number): number => {
    let left = 0, right = nums.length - 1;
    while (left <= right) {
        const mid = Math.floor((left + right) / 2);
        if (nums[mid] === target) return mid;
